...
module.exports = function createVueApp(opts) {
  ...
  copyDir({
    ...
    .then(execShellInProjectWithMessageFactory(opts, 'git init'))
    ...
    .then(execShellInProjectWithMessageFactory(opts, 'git add .'))
    .then(execShellInProjectWithMessageFactory(opts, 'git commit -m "init"'))
...
function execShellInProjectWithMessageFactory(opts, script) {
  const projectPath = opts.projectPath;
